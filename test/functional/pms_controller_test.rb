...
class PmsControllerTest < ActionController::TestCase
  ...
  test "should create pm" do
    assert_difference('Pm.count') do
      post :create, :pm => { :message => @pm.message, :read => @pm.read, :sender_id => @pm.sender_id, :user_id => @pm.user_id }
    end
  ...
  test "should update pm" do
    put :update, :id => @pm, :pm => { :message => @pm.message, :read => @pm.read, :sender_id => @pm.sender_id, :user_id => @pm.user_id }
    assert_redirected_to pm_path(assigns(:pm))
  end
